...
class PersonInfoTest : FunSpec({
    ...
    context("Ytelse") {
        ...
        test("ytelse med grunnbeløp 2g, 7 barn og 0 arbeidsgrad") {
            ...
            respons.logs[0] shouldBe "Fordi lønnen din er lavere enn grensen for minste utbetaling blir grunnlaget ditt <strong>337 809 kr</strong>."
            respons.logs[1] shouldBe "Ytelsen utgjør 66% av grunnlaget, og blir derfor <strong>225 206 kr</strong>."
            respons.logs[2] shouldBe "For hvert barn får du 7 020 kr per år. Siden du har 7 barn vil du få 49 140 kr i tillegg. Dette blir til sammen <strong>274 346 kr</strong>."
        }
        ...
        test("ytelse med grunnbeløp 2g, 15 barn og 50% arbeidsgrad") {
            ...
            respons.logs[0] shouldBe "Fordi lønnen din er lavere enn grensen for minste utbetaling blir grunnlaget ditt <strong>337 809 kr</strong>."
            respons.logs[1] shouldBe "Ytelsen utgjør 66% av grunnlaget, og blir derfor <strong>225 206 kr</strong>."
            respons.logs[2] shouldBe "For hvert barn får du 7 020 kr per år. Barnetillegg sammen med ytelsen kan ikke være mer enn 90% av grunnlaget. Derfor får du 78 823 kr i tillegg. Dette blir til sammen <strong>304 028 kr</strong>."
            respons.logs[3] shouldBe "En vanlig arbeidsuke er 37,5 timer. Siden du jobber 18.75 timer i uken blir ytelsen redusert med 50%, fra 304 028 kr til <strong>152 014 kr</strong>. "
        }
