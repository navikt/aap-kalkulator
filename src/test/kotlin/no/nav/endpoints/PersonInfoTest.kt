...
class PersonInfoTest : FunSpec({
    context("Ytelse") {
        ...
        test("ytelse med grunnbeløp 2g, 7 barn og 0 arbeidsgrad") {
            ...
            respons.logs[0] shouldBe "2g fix me pls"
            respons.logs[1] shouldBe "Ytelsen etter utregning av grunnlag er 147149.64 kr. Ytelsen utgjør 66 prosent av grunnlaget."
            respons.logs[2] shouldBe "For hvert barn du har får du 27 kr per dag. Siden du har 7 barn vil du få 49140 kr i tillegg til ytelsen din."
        }
        ...
        test("ytelse med grunnbeløp 2g, 8 barn og 50% arbeidsgrad") {
            ...
            respons.logs[0] shouldBe "2g fix me pls"
            respons.logs[1] shouldBe "Ytelsen etter utregning av grunnlag er 147149.64 kr. Ytelsen utgjør 66 prosent av grunnlaget."
            respons.logs[2] shouldBe "maks barn help me pls"
            respons.logs[3] shouldBe "Aap vil være redusert med 50 prosent."
        }
